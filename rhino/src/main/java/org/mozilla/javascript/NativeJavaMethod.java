...
public class NativeJavaMethod extends BaseFunction {
    ...
    private static int preferSignature(
        ...
        final Class<?>[] types1 = member1.argTypes;
        final Class<?>[] types2 = member2.argTypes;
    ...
    static int[] failFastConversionWeights(Object[] args, MemberBox member) {
        final Class<?>[] argTypes = member.argTypes;
        ...
        for (int i = 0; i < typeLen; i++) {
            final int weight = NativeJavaObject.getConversionWeight(args[i], argTypes[i]);
