...
public abstract class ScriptableObject
    ...
    private LambdaAccessorSlot ensureLambdaAccessorSlot(
            ...
            BiConsumer<Scriptable, Object> setter,
            int attributes) {
        LambdaAccessorSlot newSlot = createLambdaAccessorSlot(name, index, existing, getter, setter, attributes);
        ScriptableObject newDesc = newSlot.getPropertyDescriptor(cx, this);
        ...
        if (existing == null) {
            ...
            LambdaAccessorSlot slot = (LambdaAccessorSlot) existing;
            ScriptableObject existingDesc = slot.getPropertyDescriptor(cx, this);
            checkPropertyChange(name, existingDesc, newDesc);
            return newSlot;
        } else {
            ScriptableObject existingDesc = existing.getPropertyDescriptor(cx, this);
            checkPropertyChange(name, existingDesc, newDesc);
            return newSlot;
        }
    }
